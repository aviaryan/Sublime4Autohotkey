...
Gui, Add, Button, x430 y320 h30 w90 Default ginsert, &Insert
...
Gui, Show, , MsgBox Creator for Sublime4Autohotkey
...
FileAppend, #NoTrayIcon`n%Msgbox_Command%, %A_Temp%\MsgboxTemp.ahk
...
insert:
Gui, Hide
WinWaitClose, MsgBox Creator for Sublime4Autohotkey
WinActivate, ahk_class PX_WINDOW_CLASS
SendPlay,% Msgbox_Command
ExitApp
Return
